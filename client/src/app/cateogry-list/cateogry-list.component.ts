...
categories = [
  { title: 'Dentist', text: 'Dentists help keep your teeth, gums, and mouth healthy. They treat cavities, prevent oral diseases,&improve smiles through regular care and treatments.', icon: 'fa-solid fa-tooth' },
  { title: 'Cardiologist', text: 'SCardiologists are doctors who specialize in heart health. They diagnose, treat, and help prevent heart and blood vessel diseases to keep your heart strong.', icon: 'fa-solid fa-heart-pulse' },
